...
/**
 * Controller for Select Astrologer functionality
 * Handles astrologer selection for lucky color matching
 */
@RestController
@RequestMapping("/api/astrologer")
public class SelectAstrologerController {

    @Autowired
    private AstrologerService astrologerService;

    /**
     * Get all astrologers for selection
     */
    @GetMapping("/list")
